...
Im Endeffekt sind am Code dieses verwendeten Buildsystems mehrere Hundert Autoren beteiligt, da die verwendeten Module wiederum selber auf weiteren Modulen aufgebaut sind.
...
Cascading Style Sheets (CSS) beschreiben die Darstellung der anzuzeigenden Elemente, die in HTML-Dokumenten oder SVG-Grafiken vorkommen. In dieser Software wird das CSS-Framework \textit{Basscss} \cite{basscss} verwendet, es erleichtert die Gestaltung der Weboberfläche.

\subsection{Originalität des Codes bei der Implementierung von Programmbibliotheken}

Der Applikationscode und das Applikationsdesign wurde selber erstellt, falls nicht anders angemerkt durch Kommentare.

Bei der Verwendung von Programmierbibliotheken (D3, three.js, tween.js) und Buildsystemen (NPM, Gulp.js) wird der Code nach Anweisung der entsprechenden Dokumentation geschrieben.