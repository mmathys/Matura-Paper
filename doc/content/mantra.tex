...
\textbf{Filter.} Die Filter-Funktion ermöglicht dem Benutzer, gewisse Elemente oder Elementgruppen je nach Interesse ein- oder auszublenden. Diese Filter-Funktion der Benutzeroberfläche ist nicht zu verwechseln mit dem Filtern von Datensätzen, das Rohdaten in aufbereitete Daten umwandelt.
